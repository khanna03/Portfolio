 ...
 * 
 * Provides global site navigation with a sticky glassmorphism effect.
 * Implements scroll-spy functionality to highlight the currently active section.
 * Includes a responsive mobile drawer menu for smaller screens.
 */
"use client";
