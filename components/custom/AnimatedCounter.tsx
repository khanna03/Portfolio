 ...
 * 
 * Smoothly animates a numeric value from 0 to a target number when the component scrolls into view.
 * Utilizes `requestAnimationFrame` for high-performance ease-out animation.
