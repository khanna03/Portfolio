 ...
 * 
 * Defines the global HTML structure, fonts, SEO metadata, and JSON-LD schema for the entire portfolio application.
 * Initializes Google Fonts (Playfair Display, Inter, JetBrains Mono) and sets up the foundational styling themes.
 */
